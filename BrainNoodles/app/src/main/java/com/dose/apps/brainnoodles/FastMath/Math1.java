...
public class Math1 extends Activity {
    int rand1, rand2, randDecider, correctAnswer, falseAnswer, problemsSolved, mathNum;
...
//Starting the timer
        mathTimer = new MathTimer(timerTV, 2000, 1000);
        mathTimer.start();
